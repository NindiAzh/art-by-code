                        ...
                        <div className="flex items-center mx-32 justify-between w-full">
                                ...
                                <div className="hidden md:block">
                                    <div className="ml-10 flex items-baseline space-x-6 font-nuni">
                                        <Link href="/tentang"><a className="hover:text-puerto-rico-500 cursor-pointer text-black font-bold px-3 py-2 text-[18px] hover:underline transition-all">Tentang Kami</a></Link>
                                        <Link href="/solusi"><a className="hover:text-puerto-rico-500 cursor-pointer text-black px-3 py-2 rounded-md text-[18px] font-bold flex items-center hover:underline transition-all">
                                        ...
                                        <Link href="/carakerja"><a className="hover:text-puerto-rico-500 cursor-pointer text-black px-3 py-2 rounded-md text-[18px] font-bold hover:underline transition-all">Cara Kerja</a></Link>
                                        <Link href="#"><a className="hover:text-puerto-rico-500 cursor-pointer text-black px-3 py-2 rounded-md text-[18px] font-bold hover:underline transition-all">Karya Kami</a></Link>
